...
edit = "xpath://tr[@id='30']//i[@class='fa fa-edit']" # Must Change Recruitment Request ID in every run
...
# Job Criteria
job_criteria = "xpath://tr[@id='14']//i[@class='fa fa fa-plus']" # Must Change id with respect to Recruitment ID number.
...
job_publish = "xpath://tr[@id='14']//a[@class='btn btn-warning btn-sm1 status']"    # Must Focus on ID Number of the Job to be published
